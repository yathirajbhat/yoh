...
public class RegistrationController {
	...
	public String listUsers(ModelMap model) {
		...
		List<RegisterUser> users = userService.findAllUsers();
	...
	public String saveUser(@Valid RegisterUser user, BindingResult result,
			ModelMap model) {
	 ...
	 */
	@RequestMapping(value = { "/edit-registeruser-{ssoId}" }, method = RequestMethod.GET)
	 ...
	 */
	@RequestMapping(value = { "/edit-registeruser-{ssoId}" }, method = RequestMethod.POST)
	public String updateUser(@Valid RegisterUser user, BindingResult result,
